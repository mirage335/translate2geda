...
public class DrawnElement extends FootprintElementArchetype
{
  ...
  private static long mmTextToNM(String mmValue) {
    mmValue = mmValue.replaceAll("[\"]","");
    return (long)(1000000*Float.parseFloat(mmValue)); 
  }


  private static long milToNM(float rawValue)
  {
    return (long)(rawValue * 25400 ); // 1 mil unit = 25400 nm
  }


  private static long convertToNanometres(float rawValue, Boolean metricSystem)
  {
    if (metricSystem)
      {
